...
/**
 * JVM actual for [Ed25519], backed by BouncyCastle's `Ed25519Signer` /
 * `Ed25519PrivateKeyParameters`. Pin: `org.bouncycastle:bcprov-jdk18on:1.78+`.
 *
 * See the approved OpenSpec proposal `add-ed25519-platform-crypto-impl`
 * (design.md in openspec/changes/ while active, or archived form after merge)
 * for the rationale.
 */
